...
- Root — the **`ltm-dashboard`** application. Visual dashboard of Airbus **Lab Test Means** (LTM) backed by the live `atom-synchronizer-dev` API. Runs on port **3002**.
...
npm start          # serve the build on 3002 c
```
